...
public class AuthHome extends AppCompatActivity {
    ...
    private String email,pass,userid,name,type,email_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.auth_home);
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    UserPojo userPojo = new UserPojo(user.getDisplayName(),email_id, user.getUid());
        ...
        sign_in.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                firebaseAuth.signInWithEmailAndPassword(email,pass).addOnCompleteListener(AuthHome.this, new OnCompleteListener<AuthResult>() {
                    @Override
        ...
        sign_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AuthHome.this,Registration.class);
    ...
    private void firebaseAuthGoogle(final GoogleSignInAccount account) {
        ...
        firebaseAuth.signInWithCredential(authCredential)
                .addOnCompleteListener(AuthHome.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful())
                        {
                            Toast.makeText(AuthHome.this, "Something went wrong! Try Again.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void handleFacebookAccessToken(final AccessToken accessToken) {
        AuthCredential authCredentialFB = FacebookAuthProvider.getCredential(accessToken.getToken());
